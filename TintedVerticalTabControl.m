         ...
         tintColor:(UIColor *)color 
{
    ...
    if (self) {
        ...
        ((BadgeView *)self.badgeView).badgeColor = [UIColor orangeColor];
    }
...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    return CGSizeMake(70.0f, 150.0f);
}
...
- (void)layoutSubviews {
    ...
    badgeView.frame = CGRectMake(44.0f, 23.0f, badgeView.viewWidth, badgeView.viewHeight);
}
